VECM.model.ex.stock.multiple<-function(cluster.data1,cluster.data2,pred.data,ex.data,
                              lagvalue=1,rvalue=1,aheadv=2){
    ...
    model<-VECM(cbind(cluster.data1[,2],cluster.data2[,2],pred.data[,2],
                      ex.data[,-1]),lag=lagvalue,r=rvalue)
